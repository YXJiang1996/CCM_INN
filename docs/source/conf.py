...
project = 'FrEIA'
copyright = '2018, Lynton Ardizzone'
author = 'Lynton Ardizzone'
...
latex_documents = [
    (master_doc, 'FrEIA.tex', 'FrEIA Documentation',
     'Lynton Ardizzone', 'manual'),
]
...
man_pages = [
    (master_doc, 'freia', 'FrEIA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FrEIA', 'FrEIA Documentation',
     author, 'FrEIA', 'One line description of project.',
     'Miscellaneous'),
]
